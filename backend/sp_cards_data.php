...
function sp_cards_base() {
  ...
  $c['exobiologist'] = [
    ...
    'kind' => 'starter', 'stage' => null, 'cost_credits' => 0, 'rider_credits' => 0,
    'text' => 'PLANT: this card enters the field at Biology stat +1, and ONE other biologist from your hand may join it free. Both grow +1 at the start of your turns. HARVEST (its own action) resolves them one at a time.',
  ];
  $c['talent_scout'] = [
  ...
  $mk('geneticist', 'Geneticist', 'biology', 0, 0, 3, 'trade_guild', 1, 3, 0,
      'PLANT: enters the field at Biology 3 +1; one other biologist from your hand may join free. +1 growth per turn; resolve via Harvest.');
  ...
  $mk('ecologist', 'Ecologist', 'biology', 0, 0, 4, 'trade_guild', 2, 4, 0,
      'PLANT: enters the field at Biology 4 +1; one other biologist from your hand may join free. +1 growth per turn; resolve via Harvest.');
  ...
  $mk('biome_designer', 'Biome Designer', 'biology', 0, 0, 5, 'trade_guild', 3, 6, 0,
      'PLANT: enters the field at Biology 5 +1; one other biologist from your hand may join free. +1 growth per turn; resolve via Harvest.');
  ...
  $mk('lifewright', 'Lifewright', 'biology', 0, 0, 6, 'trade_guild', 5, 10, 0,
      'PLANT: enters the field at Biology 6 +1; one other biologist from your hand may join free. +1 growth per turn; resolve via Harvest.');
