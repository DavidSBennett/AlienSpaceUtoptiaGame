  ...
  $m = [
    ...
    'm_silent_reef' => [
      ...
      'solutions' => [
        ...
        'anthro' => ['difficulty' => 2, 'chaos' => -2, 'credits' => 4,
    ...
    'm_salt_bloom' => [
      ...
      'solutions' => [
        ...
        'bio' => ['difficulty' => 3, 'chaos' => 2, 'credits' => 5,
    ...
    'm_binding_suns' => [
      ...
      'solutions' => [
        'geo' => ['difficulty' => 6, 'chaos' => -3, 'credits' => 10, 'follow' => 'f_sundered_kin',
        ...
        'bio' => ['difficulty' => 5, 'chaos' => 3, 'credits' => 8, 'follow' => 'f_grey_garden',
    ...
    'm_hollow_herd' => [
      ...
      'solutions' => [
        'geo' => ['difficulty' => 6, 'chaos' => -3, 'credits' => 10,
        ...
        'bio' => ['difficulty' => 5, 'chaos' => 3, 'credits' => 8, 'follow' => 'f_hollow_song',
    ...
    'm_starving_signal' => [
      ...
      'solutions' => [
        'geo' => ['difficulty' => 7, 'chaos' => -2, 'credits' => 9,
        ...
        'bio' => ['difficulty' => 5, 'chaos' => -3, 'credits' => 8,
    ...
    'm_glasswing' => [
      ...
      'solutions' => [
        'geo' => ['difficulty' => 6, 'chaos' => -3, 'credits' => 9,
    ...
    'm_court_echoes' => [
      ...
      'solutions' => [
        'geo' => ['difficulty' => 6, 'chaos' => 3, 'credits' => 8,
        ...
        'bio' => ['difficulty' => 7, 'chaos' => -2, 'credits' => 9,
    ...
    'm_ascension_engine' => [
      ...
      'solutions' => [
        ...
        'anthro' => ['difficulty' => 10, 'chaos' => -4, 'credits' => 11,
        ...
        'bio' => ['difficulty' => 10, 'chaos' => 3, 'credits' => 12,
    ...
    'm_seed_of_ruin' => [
      ...
      'solutions' => [
        ...
        'bio' => ['difficulty' => 9, 'chaos' => -4, 'credits' => 13,
    ...
    'f_moth_collapse' => [
      ...
      'solutions' => [
        'geo' => ['difficulty' => 3, 'chaos' => 2, 'credits' => 4,
    ...
    'f_cultivar_spread' => [
      ...
      'solutions' => [
        ...
        'bio' => ['difficulty' => 2, 'chaos' => -2, 'credits' => 5,
    ...
    'f_gate_seed' => [
      ...
      'solutions' => [
        'geo' => ['difficulty' => 5, 'chaos' => 3, 'credits' => 8,
      ...
      if ($chaos >= 3) {
        ...
        if ($minorSlot === 3) {
          $sol['boon'] = ['type' => 'severance', 'name' => 'Severance Authority',
            'text' => 'During a Regroup you may fire crew permanently: +4 credits each, +1 per 3 chaos.'];
        } elseif ($minorSlot === 0) {
